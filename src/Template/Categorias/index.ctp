                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="align-middle text-center">
                        <a class="btn btn-sm btn-dark" href="<?= $this->Url->build(['controller' => 'Categorias', 'action' => 'view', $categoria->id]); ?>">
                          ...
                          <!-- corrigir -->
                          <a class="btn btn-sm btn-dark" href="<?= $this->Url->build(['controller' => 'Categorias', 'action' => 'delete', $categoria->id], ['confirm' => __('Are you sure you want to delete # {0}?', $categoria->id)]); ?>">
