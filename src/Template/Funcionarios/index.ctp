                    ...
                    <tr>
                      ...
                      <td class="align-middle text-center">
                        <a class="btn btn-sm btn-dark" href="<?= $this->Url->build(['controller' => 'Funcionarios', 'action' => 'view', $funcionario->id]); ?>">
                            ...
                            <!-- corrigir -->
                            <a class="btn btn-sm btn-dark" href="<?= $this->Url->build(['controller' => 'Funcionarios', 'action' => 'delete', $funcionario->id], ['confirm' => __('Are you sure you want to delete # {0}?', $funcionario->id)]); ?>">
