                ...
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="align-middle text-center">
                        <a class="nav-link " href="<?= $this->Html->link(__('View'), ['action' => 'view', $funcionario->id]) ?>"> </a>
                        <a class="nav-link " href=" <?= $this->Html->link(__('Edi'), ['action' => 'edit', $funcionario->id]) ?> "> </a>
                        <a class="nav-link " href=" <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $funcionario->id], ['confirm' => __('Are you sure you want to delete # {0}?', $funcionario->id)]) ?>"> </a>
                      </td>
                    </tr>
                    <?php endforeach;?>
                  </tbody>
