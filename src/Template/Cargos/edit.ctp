            ...
            <div class="card-header pb-0 p-3">
                <div class="row">
                    <div class="col-md-8 col-9">
                        <h6 class="mb-0 font-weight-semibold text-lg">Editar Cargo</h6>
                        <p class="text-sm mb-1">Edite os campos do cargo selecionado</p>
                    </div>
                    <div class="">
                        ...
                        <form class="row g-3">
                            ...
                            <div class="col-md-4 pb-3">
                                <?php echo $this->Form->control('categoria_id',['type' => 'select','label' => 'Categoria', 'options' => $categorias, 'class' => 'form-select', 'required']);?>
                            </div>
