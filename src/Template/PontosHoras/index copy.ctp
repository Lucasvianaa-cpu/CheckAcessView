                      ...
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center ms-1">
                            <h6 class="mb-0 text-sm font-weight-semibold">  <?= $pontosHora->data_ponto->format('d/m/Y') ?></h6>
                          </div>
                      </td>
                      <td>
                          <div class="d-flex flex-column justify-content-center ms-1">
                            <h6 class="mb-0 text-sm font-weight-semibold">  <?= $pontosHora->hora->format('H:i:s') ?></h6>
                          </div>
                      </td>
