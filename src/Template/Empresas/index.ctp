                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="align-middle text-center">
                        <a class="btn btn-sm btn-dark" href="<?= $this->Url->build(['controller' => 'Empresas', 'action' => 'view', $empresa->id]); ?>">
                            ...
                            <!-- corrigir -->
                            <a class="btn btn-sm btn-dark" href="<?= $this->Url->build(['controller' => 'Empresas', 'action' => 'delete', $empresa->id], ['confirm' => __('Are you sure you want to delete # {0}?', $empresa->id)]); ?>">
