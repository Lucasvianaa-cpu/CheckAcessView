                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="align-middle text-center">
                        <a class="btn btn-sm btn-dark" href="<?= $this->Url->build(['controller' => 'Equipamentos', 'action' => 'view', $equipamento->id]); ?>">
                            ...
                            <!-- corrigir -->
                            <a class="btn btn-sm btn-dark" href="<?= $this->Url->build(['controller' => 'Equipamentos', 'action' => 'delete', $equipamento->id], ['confirm' => __('Are you sure you want to delete # {0}?', $equipamento->id)]); ?>">
