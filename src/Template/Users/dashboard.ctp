      ...
      <div class="col-md-12">
        <div class="d-md-flex align-items-center mb-3 mx-2">
          <div class="mb-md-0 mb-3">
            ...
            <p class="mb-0">Permissão: <?= $descricaoRole ?></p>
          </div>
          ...
          <div class="card shadow-xs border h-100">
            <div class="card-header pb-0">
              ...
              <ul class="list-group">
                ...
                <li class="list-group-item border-0 ps-0 text-dark font-weight-semibold pb-1 text-sm"><span class="text-secondary">CNPJ:</span> &nbsp; <?= $empresa->cnpj ?>
                </li>
                ...
                <li class="list-group-item border-0 ps-0 text-dark font-weight-semibold pb-1 text-sm"><span class="text-secondary">Quantidade de Funcionários:</span> &nbsp; <?= $empresa->qtd_funcionarios ?>
                </li>
              </ul>
      ...
      <?php if ($current_user['role_id'] == 2) : ?>
        <div class="row my-4">
          <div class="col-lg-4 col-md-6 mb-md-0 mb-4">
            <div class="card shadow-xs border h-100">
              <div class="card-header pb-0">
                <h6 class="font-weight-semibold text-lg mb-2">Dados Principais</h6>
                <hr class="my-0 mb-3">
                <ul class="list-group">
                  <li class="list-group-item border-0 ps-0 text-dark font-weight-semibold pt-0 pb-1">
                    <span class="text-secondary">Nome:</span> &nbsp; <?= $current_user['nome'] ?>
                  </li>
                  ...
                  <li class="list-group-item border-0 ps-0 text-dark font-weight-semibold pb-1"><span class="text-secondary">Tag RFID:</span> &nbsp;
                    <?= $current_user['uid_rfid'] ?></li>
                </ul>
                  ...
                  <div class="col-12">
                    <div class="w-100">
                      ...
                      <div class="d-flex align-items-center">
                        ...
                        <span class="text-sm ms-1">Lançamento de Holerites</span>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="col-12">
                    <div class="w-100">
                      ...
                      <div class="d-flex align-items-center">
                        ...
                        <span class="text-sm ms-1">Relatórios de RH</span>
                      </div>
                    </div>
                  </div>
                </div>
